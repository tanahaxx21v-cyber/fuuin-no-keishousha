...
export const LOCATIONS: Record<LocationId, LocationDef> = {
  ...
  alseria: {
    ...
    connections: ['checkpoint', 'traveler_inn', 'great_bridge'],
    travelDays: { checkpoint: 1, traveler_inn: 1, great_bridge: 1 },
    companionId: 'gares',
  ...
  bern: {
    ...
    connections: ['checkpoint', 'watchtower', 'bandit_hideout'],
    travelDays: { checkpoint: 2, watchtower: 2, bandit_hideout: 2 },
    companionId: 'noa',
  ...
  sahal: {
    ...
    type: 'town',
    desc: '東の砂漠に築かれた都市。砂漠の民が暮らす異国情緒あふれる場所。',
    connections: ['bandit_hideout', 'lighthouse'],
    travelDays: { bandit_hideout: 2, lighthouse: 3 },
    companionId: 'logan',
  ...
  mirea: {
    ...
    type: 'town',
    desc: '南の海に面した賑やかな港町。海路の交差点で、様々な情報が集まる。',
    connections: ['riverside', 'lighthouse'],
    travelDays: { riverside: 2, lighthouse: 2 },
    companionId: 'sig',
  ...
  elna: {
    ...
    type: 'town',
    desc: '西の深緑の森に囲まれた小さな里。穏やかな人々が暮らす自然豊かな場所。',
    connections: ['traveler_inn', 'ancient_temple'],
    travelDays: { traveler_inn: 2, ancient_temple: 3 },
    companionId: 'bram',
  ...
  galdo: {
    ...
    type: 'town',
    desc: '北の要衝に立つ大都市。各地の冒険者が集まり、北方への探索拠点となっている。',
    connections: ['watchtower', 'demon_mine', 'dragon_pass', 'beast_forest'],
    travelDays: { watchtower: 2, demon_mine: 2, dragon_pass: 3, beast_forest: 4 },
    companionId: 'cecil',
  ...
  traveler_inn: {
    ...
    type: 'relay',
    desc: 'アルセリアとエルナの里を結ぶ街道沿いの宿屋。旅人の憩いの場。',
    connections: ['alseria', 'elna'],
    travelDays: { alseria: 1, elna: 2 },
    hasInn: true,
    shopItems: ['potion', 'antidote'],
  },
  checkpoint: {
    id: 'checkpoint', name: '関所', emoji: '🚧',
    type: 'relay',
    desc: 'アルセリアとベルンを結ぶ交通の要衝。往来する商人を監視している。',
  ...
  great_bridge: {
    ...
    type: 'relay',
    desc: 'ルーテ大河に架かる大きな橋。南北をつなぐ唯一の通路。',
    connections: ['alseria', 'riverside'],
    travelDays: { alseria: 1, riverside: 1 },
  },
  riverside: {
    id: 'riverside', name: '川辺の村', emoji: '🏡',
    type: 'relay',
    desc: '大河のほとりにある小さな村。旅人の中継地点として機能している。',
    connections: ['great_bridge', 'mirea'],
    travelDays: { great_bridge: 1, mirea: 2 },
    companionId: 'finn',
    hasInn: true,
  ...
  watchtower: {
    ...
    type: 'relay',
    desc: 'ベルンとガルドを結ぶ街道の中継地点。兵士が北方を監視している。',
  ...
  lighthouse: {
    ...
    type: 'relay',
    desc: '南東の岬に立つ灯台。海路とサハルを結ぶ中継地。',
    connections: ['mirea', 'sahal'],
    travelDays: { mirea: 2, sahal: 3 },
    shopItems: ['potion', 'antidote'],
  },

  // ===== DUNGEONS =====
  demon_mine: {
    id: 'demon_mine', name: '魔鉱山', emoji: '⛏️',
    type: 'dungeon',
    desc: '北方の山中に潜む鉱山。炎の精霊が棲み、炎の封印石が眠ると言われる。魔王軍の残党も潜伏中。',
    connections: ['galdo'],
    travelDays: { galdo: 2 },
    companionId: 'iris',
    sealStone: 'fire',
  ...
  bandit_hideout: {
    id: 'bandit_hideout', name: '盗賊の隠れ家', emoji: '💰',
    type: 'dungeon',
    desc: 'ベルンとサハルの間に潜む盗賊団の本拠地。ヴァイスの過去と深く関わっている。',
    connections: ['bern', 'sahal'],
    travelDays: { bern: 2, sahal: 2 },
    companionId: 'vais',
  ...
  ancient_temple: {
    ...
    type: 'dungeon',
    desc: 'エルナの里の沖合にある島の神殿。闇の封印石が祀られており、エルフのミラが守護している。',
    connections: ['elna'],
    travelDays: { elna: 3 },
    companionId: 'mira',
    sealStone: 'dark',
  ...
  beast_forest: {
    id: 'beast_forest', name: '魔獣の森', emoji: '🌑',
    type: 'castle',
    desc: '魔王ヴァールドが復活を待つ禁断の森。3つの封印石を持つ者だけが真の決戦に挑める。謎めいた存在ゼノもここにいる。',
    connections: ['galdo'],
    travelDays: { galdo: 4 },
    companionId: 'zeno',
