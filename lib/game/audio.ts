...
// アルセリア王都BGM — Cメジャー 荘厳・王城 BPM88
const ALSERIA_MEL: NoteSeq = [
  ['C5',0.5],['E5',0.5],['G5',1.0], ['F5',0.5],['E5',0.5],['D5',1.0],
  ['E5',0.5],['D5',0.5],['C5',0.5],['B4',0.5], ['C5',2.0],
  ['G4',0.5],['A4',0.5],['B4',0.5],['C5',0.5], ['D5',1.0],['E5',1.0],
  ['F5',0.5],['G5',0.5],['E5',1.0], ['D5',0.5],['C5',0.5],['C5',1.0],
]
const ALSERIA_HAR: NoteSeq = [
  ['E4',1.0],['C4',1.0], ['A4',1.0],['F4',1.0],
  ['G4',1.0],['E4',1.0], ['A4',2.0],
  ['E4',1.0],['G4',1.0], ['B4',1.0],['C5',1.0],
  ['A4',1.0],['G4',1.0], ['E4',1.0],['C4',1.0],
]
const ALSERIA_BAS: NoteSeq = [
  ['C3',1.0],['R',1.0], ['F3',1.0],['G3',1.0],
  ['G3',1.0],['E3',1.0], ['A3',1.0],['R',1.0],
  ['C3',1.0],['G2',1.0], ['F3',1.0],['C3',1.0],
  ['A2',1.0],['G2',1.0], ['C3',2.0],
]

// ベルン商業都市BGM — Gメジャー 活気・商業 BPM120
const BERN_MEL: NoteSeq = [
  ['G4',0.5],['A4',0.5],['B4',0.5],['C5',0.5], ['D5',0.5],['E5',0.5],['D5',0.5],['C5',0.5],
  ['B4',0.5],['C5',0.5],['A4',1.0], ['G4',2.0],
  ['D5',0.5],['E5',0.5],['Fs5',0.5],['G5',0.5], ['A5',0.5],['G5',0.5],['Fs5',0.5],['E5',0.5],
  ['D5',0.5],['B4',0.5],['C5',0.5],['A4',0.5], ['G4',2.0],
]
const BERN_HAR: NoteSeq = [
  ['G3',0.5],['B3',0.5],['G3',0.5],['B3',0.5], ['D4',0.5],['B3',0.5],['D4',0.5],['B3',0.5],
  ['G3',0.5],['B3',0.5],['D4',0.5],['C4',0.5], ['B3',2.0],
  ['A3',0.5],['C4',0.5],['A3',0.5],['C4',0.5], ['D4',0.5],['C4',0.5],['A3',0.5],['G3',0.5],
  ['B3',0.5],['G3',0.5],['E4',0.5],['D4',0.5], ['G3',2.0],
]
const BERN_BAS: NoteSeq = [
  ['G2',0.5],['R',0.5],['G2',0.5],['R',0.5], ['G2',0.5],['R',0.5],['D3',0.5],['R',0.5],
  ['G2',0.5],['R',0.5],['C3',0.5],['R',0.5], ['D3',0.5],['R',0.5],['G2',0.5],['R',0.5],
  ['D3',0.5],['R',0.5],['D3',0.5],['R',0.5], ['A3',0.5],['R',0.5],['D3',0.5],['R',0.5],
  ['G2',0.5],['R',0.5],['E3',0.5],['R',0.5], ['D3',0.5],['R',0.5],['G2',0.5],['R',0.5],
]

// サハル砂漠都市BGM — Aフリジアン 異国・砂漠 BPM98
const SAHAL_MEL: NoteSeq = [
  ['A4',0.5],['Bb4',0.5],['C5',1.0], ['A4',0.5],['G4',0.5],['A4',1.0],
  ['G4',0.5],['F4',0.5],['E4',0.5],['G4',0.5], ['A4',2.0],
  ['C5',0.5],['D5',0.5],['E5',0.5],['C5',0.5], ['A4',1.0],['Bb4',1.0],
  ['A4',0.5],['G4',0.5],['F4',0.5],['E4',0.5], ['A4',2.0],
]
const SAHAL_HAR: NoteSeq = [
  ['E4',1.0],['F4',1.0], ['A3',1.0],['E4',1.0],
  ['C4',1.0],['D4',1.0], ['E4',2.0],
  ['A4',1.0],['G4',1.0], ['F4',1.0],['E4',1.0],
  ['E4',1.0],['F4',1.0], ['A3',2.0],
]
const SAHAL_BAS: NoteSeq = [
  ['A2',1.5],['R',0.5], ['A2',1.5],['R',0.5],
  ['G2',1.5],['R',0.5], ['A2',1.5],['R',0.5],
  ['F2',1.5],['R',0.5], ['G2',1.5],['R',0.5],
  ['E2',1.0],['A2',1.0], ['A2',2.0],
]

// ミレア港町BGM — Gメジャー 海風・軽快 BPM116
const MIREA_MEL: NoteSeq = [
  ['G4',0.5],['B4',0.5],['D5',0.5],['G5',0.5], ['Fs5',0.5],['E5',0.5],['D5',1.0],
  ['E5',0.5],['D5',0.5],['B4',0.5],['A4',0.5], ['G4',2.0],
  ['A4',0.5],['B4',0.5],['C5',0.5],['D5',0.5], ['E5',0.5],['D5',0.5],['C5',0.5],['B4',0.5],
  ['D5',0.5],['C5',0.5],['B4',0.5],['A4',0.5], ['G4',2.0],
]
const MIREA_HAR: NoteSeq = [
  ['D4',1.0],['B4',1.0], ['A4',1.0],['G4',1.0],
  ['A3',1.0],['D4',1.0], ['G3',2.0],
  ['Fs4',1.0],['G4',1.0], ['A4',1.0],['Fs4',1.0],
  ['B4',1.0],['A4',1.0], ['G4',2.0],
]
const MIREA_BAS: NoteSeq = [
  ['G2',0.5],['R',0.5],['D3',0.5],['R',0.5], ['D3',0.5],['R',0.5],['G3',0.5],['R',0.5],
  ['A2',0.5],['R',0.5],['E3',0.5],['R',0.5], ['G2',1.0],['D3',1.0],
  ['D3',0.5],['R',0.5],['G3',0.5],['R',0.5], ['G3',0.5],['R',0.5],['D3',0.5],['R',0.5],
  ['A2',0.5],['R',0.5],['E3',0.5],['R',0.5], ['G2',2.0],
]

// エルナの里BGM — Dドリアン 神秘・エルフ BPM76
const ELNA_MEL: NoteSeq = [
  ['D5',1.5],['E5',0.5], ['F5',0.5],['E5',0.5],['D5',1.0],
  ['A4',0.5],['B4',0.5],['C5',0.5],['A4',0.5], ['G4',2.0],
  ['C5',0.5],['D5',0.5],['E5',0.5],['C5',0.5], ['B4',0.5],['A4',0.5],['G4',1.0],
  ['F4',0.5],['G4',0.5],['A4',0.5],['B4',0.5], ['D5',2.0],
]
const ELNA_HAR: NoteSeq = [
  ['A4',2.0], ['F4',1.0],['G4',1.0],
  ['F4',1.0],['G4',1.0], ['D4',2.0],
  ['G4',2.0], ['E4',1.0],['D4',1.0],
  ['C4',1.0],['D4',1.0], ['A3',2.0],
]
const ELNA_BAS: NoteSeq = [
  ['D3',2.0], ['F3',1.0],['G3',1.0],
  ['F3',1.0],['E3',1.0], ['D3',2.0],
  ['G3',2.0], ['E3',1.0],['D3',1.0],
  ['C3',1.0],['D3',1.0], ['A2',2.0],
]

// ガルド辺境都市BGM — Aマイナー 荒々しい・辺境 BPM108
const GALDO_MEL: NoteSeq = [
  ['A4',0.5],['R',0.5],['C5',0.5],['E5',0.5], ['A5',2.0],
  ['G5',0.5],['F5',0.5],['E5',0.5],['D5',0.5], ['C5',2.0],
  ['E5',0.5],['R',0.5],['G5',0.5],['A5',0.5], ['E5',2.0],
  ['D5',0.5],['C5',0.5],['B4',0.5],['A4',0.5], ['A4',2.0],
]
const GALDO_HAR: NoteSeq = [
  ['E4',1.0],['A4',1.0], ['C5',1.0],['E4',1.0],
  ['D4',1.0],['F4',1.0], ['C4',2.0],
  ['E4',1.0],['G4',1.0], ['E4',1.0],['A4',1.0],
  ['B4',1.0],['G4',1.0], ['A4',2.0],
]
const GALDO_BAS: NoteSeq = [
  ['A2',0.5],['R',0.5],['A2',0.5],['R',0.5], ['E3',0.5],['R',0.5],['E3',0.5],['R',0.5],
  ['A2',0.5],['R',0.5],['A2',0.5],['R',0.5], ['E3',0.5],['R',0.5],['G3',0.5],['R',0.5],
  ['G2',0.5],['R',0.5],['G2',0.5],['R',0.5], ['D3',0.5],['R',0.5],['D3',0.5],['R',0.5],
  ['F2',0.5],['R',0.5],['G2',0.5],['R',0.5], ['E2',0.5],['R',0.5],['A2',0.5],['R',0.5],
]

// ===== BGM制御 =====

export type BgmType = 'field' | 'town' | 'dungeon' | 'battle' | 'boss' | 'alseria' | 'bern' | 'sahal' | 'mirea' | 'elna' | 'galdo'
...
export function playBgm(type: BgmType) {
  ...
  switch (type) {
    ...
    case 'alseria':
      currentBgmStop = playMultiLoop([
        { seq: ALSERIA_MEL, type: 'square',   vol: 0.10 },
        { seq: ALSERIA_HAR, type: 'triangle', vol: 0.06 },
        { seq: ALSERIA_BAS, type: 'sawtooth', vol: 0.08 },
      ], 88)
      break
    case 'bern':
      currentBgmStop = playMultiLoop([
        { seq: BERN_MEL, type: 'square',   vol: 0.11 },
        { seq: BERN_HAR, type: 'triangle', vol: 0.07 },
        { seq: BERN_BAS, type: 'sawtooth', vol: 0.08 },
      ], 120)
      break
    case 'sahal':
      currentBgmStop = playMultiLoop([
        { seq: SAHAL_MEL, type: 'triangle', vol: 0.11 },
        { seq: SAHAL_HAR, type: 'square',   vol: 0.06 },
        { seq: SAHAL_BAS, type: 'sawtooth', vol: 0.09 },
      ], 98)
      break
    case 'mirea':
      currentBgmStop = playMultiLoop([
        { seq: MIREA_MEL, type: 'triangle', vol: 0.11 },
        { seq: MIREA_HAR, type: 'square',   vol: 0.06 },
        { seq: MIREA_BAS, type: 'sawtooth', vol: 0.07 },
      ], 116)
      break
    case 'elna':
      currentBgmStop = playMultiLoop([
        { seq: ELNA_MEL, type: 'triangle', vol: 0.10 },
        { seq: ELNA_HAR, type: 'triangle', vol: 0.05 },
        { seq: ELNA_BAS, type: 'sawtooth', vol: 0.06 },
      ], 76)
      break
    case 'galdo':
      currentBgmStop = playMultiLoop([
        { seq: GALDO_MEL, type: 'square',   vol: 0.12 },
        { seq: GALDO_HAR, type: 'sawtooth', vol: 0.06 },
        { seq: GALDO_BAS, type: 'sawtooth', vol: 0.10 },
      ], 108)
      break
  }
}
